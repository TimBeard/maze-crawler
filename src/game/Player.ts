...
export class Player {
    ...
    constructor(x: number = 1, y: number = 1, direction: Direction = Direction.NORTH) {
        this.x = x
        this.y = y
     ...
     */
    private canMoveTo(x: number, y: number, grid: number[][], corridorType: number): boolean {
     ...
     */
    public canMove(grid: number[][], corridorType: number, direction: 'forward' | 'backward'): boolean {
